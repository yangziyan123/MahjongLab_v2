def train():
    ...
    from common import submit_param, parameter_count, drain, filtered_trimmed_lines, load_torch, tqdm
    ...
    if path.exists(state_file):
        state = load_torch(state_file, map_location=device)
